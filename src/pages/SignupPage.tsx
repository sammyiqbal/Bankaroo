      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          <Link to="/" className="flex items-center justify-center space-x-2">
            <span className="text-teal-600 font-bold text-3xl">₹</span>
            <span className="text-2xl font-bold text-gray-900">Bankaroo</span>
          </Link>
            ...
            <div>
              ...
              <div className="mt-1 relative">
                <input
                  ...
                  required
                  className="appearance-none relative block w-full px-3 py-2 pr-10 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-teal-500 focus:border-teal-500 sm:text-sm"
